                                                ...
                                                <span class="title-leaf title-leaf-gray">
                                                   ...
                                                   @if ($errors->any())
                                                        ...
                                                        <div class="alert alert-danger">
                                                            <strong>Debes diligenciar correctamente todos los campos del formulario marcados con (*) para poder continuar.</strong><br><br>
                                                            {{-- <ul>
                                            ...
                                            <div class="order-box dashboard-bg-box">
                                                <div class="order-container mb-4">
                                                    ...
                                                    <div class="order-detail">
                                                        <h4>Diligencia el formulario con la información de envío y facturación con la que deseas realizar tu compra.
                                                ...
                                                <form action="{{route('user-profile.update') }}" method="POST">
                                                    ...
                                                    <button type="submit" class="mt-4 mb-4 btn btn-primary-custom">Continuar</button>
                                                </form>
