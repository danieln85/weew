...
<head>
    ...
    <link href="{{ asset('css2?family=Russo+One&display=swap') }}" rel="stylesheet">
    <link href="{{ asset('css2-3?family=Exo+2:wght@400;500;600;700;800;900&display=swap') }}" rel="stylesheet">
    <link rel="stylesheet" href="{{ asset('css2-4?family=Public+Sans:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&display=swap')}}">
    ...
    <!-- Iconly css -->
    <link rel="stylesheet" type="text/css" href="{{ asset('css/bulk-style.css') }}">
