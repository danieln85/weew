                ...
                <div class="col-lg-4">
                    ...
                    <form>
                        <script
                            ...
                            data-customer-data:phone-number="{{ $user->mobile_number }}"
                            data-customer-data:phone-number-prefix="+57"
                            data-customer-data:legal-id="{{ $user->id_number }}"
                            data-customer-data:legal-id-type="CC"
                            data-shipping-address:address-line-1="{{ $user->address }}"
                            data-shipping-address:address-line-2="{{ $user->comments }}"
                            data-shipping-address:country="CO"
                            data-shipping-address:city="{{ $user->city }}"
